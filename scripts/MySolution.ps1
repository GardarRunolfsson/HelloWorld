...
$replaceValues = @{
    ...
    "2.0.0.0" = "1.0.0.0"
    "https://businesscentralapps.azureedge.net/githubhelloworld-appsource/latest/apps.zip" = "https://businesscentralapps.blob.core.windows.net/githubhelloworld-preview/latest/apps.zip"
    "hw_" = "hw_"
    "dk,us" = "dk,us"
} + $replaceObjectIds
